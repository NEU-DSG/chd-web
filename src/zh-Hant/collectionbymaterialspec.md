...
permalink: "/zh-Hant/collectionlist/by-material-specific/"
---
{%- set grouped = collectionfolder.collectionsZhHant | groupByMultiple("material_types_specific_list.value") %}
